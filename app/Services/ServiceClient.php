...
class ServiceClient
{
    ...
    public function callbacks()
    {
        $data = DB::table('callsbacks')
            ->select('clients.id as client_id', 'callsbacks.client_id as client_id', 'clients.fullname as client', 'clients.information', 'users.id as manager_id', 'callsbacks.manager_id as manager_id', 'users.login as manager')
